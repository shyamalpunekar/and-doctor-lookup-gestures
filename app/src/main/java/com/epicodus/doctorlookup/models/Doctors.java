...
public class Doctors {
    ...
    public Doctors(String uuid, String firstName, String lastName, String title, List<String> websites, Map<String, String> phones, List<Practice> practices, boolean accepts_new_patients,
